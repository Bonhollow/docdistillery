...
def synthesize(
    ...
    while i < len(chunks):
        ...
        if summary and len(summary.strip()) > 10:
            ...
            sections.append({"title": f"Section {section_num}", "content": summary})
    ...
    if llm and sections:
        try:
            ...
            tldr = llm.generate(f"Create a 2-3 sentence summary of this document: {combined[:3000]}", max_tokens=100)
        except Exception:
            pass
    ...
    return {"tldr": tldr, "executive": executive, "sections": sections, "provenance": provenance}
